...
ALTER TABLE "public"."coach_certifications" ADD CONSTRAINT "fk_coach_certifications_certification_id_certifications_id" FOREIGN KEY("certification_id") REFERENCES "public"."certifications"("id") ON DELETE CASCADE;
ALTER TABLE "public"."chat" ADD CONSTRAINT "fk_chat_client_coach_relationship_id_client_coach_relationsh" FOREIGN KEY("client_coach_relationship_id") REFERENCES "public"."client_coach_relationship"("id") ON DELETE CASCADE;
ALTER TABLE "public"."chat_message" ADD CONSTRAINT "fk_chat_message_chat_id_chat_id" FOREIGN KEY("chat_id") REFERENCES "public"."chat"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."client_coach_relationship" ADD CONSTRAINT "fk_client_coach_relationship_request_id_client_coach_request" FOREIGN KEY("request_id") REFERENCES "public"."client_coach_request"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."coach_certifications" ADD CONSTRAINT "fk_coach_certifications_coach_id_coach_id" FOREIGN KEY("coach_id") REFERENCES "public"."coach"("id") ON DELETE CASCADE;
ALTER TABLE "public"."coach_experience" ADD CONSTRAINT "fk_coach_experience_coach_id_coach_id" FOREIGN KEY("coach_id") REFERENCES "public"."coach"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."coach_experience" ADD CONSTRAINT "fk_coach_experience_experience_id_experience_id" FOREIGN KEY("experience_id") REFERENCES "public"."experience"("id") ON DELETE CASCADE;
ALTER TABLE "public"."fitness_goals" ADD CONSTRAINT "fk_fitness_goals_client_id_client_id" FOREIGN KEY("client_id") REFERENCES "public"."client"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."availability" ADD CONSTRAINT "fk_availability_client_availability_id_client_availability_i" FOREIGN KEY("client_availability_id") REFERENCES "public"."client_availability"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."availability" ADD CONSTRAINT "fk_availability_coach_availability_id_coach_availability_id" FOREIGN KEY("coach_availability_id") REFERENCES "public"."coach_availability"("id") ON DELETE CASCADE;
ALTER TABLE "public"."client_workout_plan" ADD CONSTRAINT "fk_client_workout_plan_client_id_client_id" FOREIGN KEY("client_id") REFERENCES "public"."client"("id") ON DELETE CASCADE;
ALTER TABLE "public"."client_workout_plan" ADD CONSTRAINT "fk_client_workout_plan_workout_plan_id_workout_plan_id" FOREIGN KEY("workout_plan_id") REFERENCES "public"."workout_plan"("id") ON DELETE CASCADE;
ALTER TABLE "public"."client_telemetry" ADD CONSTRAINT "fk_client_telemetry_client_id_client_id" FOREIGN KEY("client_id") REFERENCES "public"."client"("id") ON DELETE CASCADE;
ALTER TABLE "public"."step_count" ADD CONSTRAINT "fk_step_count_client_telemetry_id_client_telemetry_id" FOREIGN KEY("client_telemetry_id") REFERENCES "public"."client_telemetry"("id") ON DELETE CASCADE;
ALTER TABLE "public"."daily_mood_survey" ADD CONSTRAINT "fk_daily_mood_survey_client_telemetry_id_client_telemetry_id" FOREIGN KEY("client_telemetry_id") REFERENCES "public"."client_telemetry"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."health_metrics" ADD CONSTRAINT "fk_health_metrics_client_telemetry_id_client_telemetry_id" FOREIGN KEY("client_telemetry_id") REFERENCES "public"."client_telemetry"("id") ON DELETE CASCADE;
ALTER TABLE "public"."client_prescribed_meal" ADD CONSTRAINT "fk_client_prescribed_meal_meal_id_meal_id" FOREIGN KEY("meal_id") REFERENCES "public"."meal"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."client_prescribed_meal" ADD CONSTRAINT "fk_client_prescribed_meal_client_id_client_id" FOREIGN KEY("client_id") REFERENCES "public"."client"("id") ON DELETE CASCADE;
...
ALTER TABLE "public"."completed_meal_activity" ADD CONSTRAINT "fk_completed_meal_activity_on_demand_meal_id_meal_id" FOREIGN KEY("on_demand_meal_id") REFERENCES "public"."meal"("id") ON DELETE CASCADE;
ALTER TABLE "public"."completed_meal_activity" ADD CONSTRAINT "fk_completed_meal_activity_client_prescribed_meal_id_client_" FOREIGN KEY("client_prescribed_meal_id") REFERENCES "public"."client_prescribed_meal"("id") ON DELETE CASCADE;
ALTER TABLE "public"."completed_meal_activity" ADD CONSTRAINT "fk_completed_meal_activity_client_telemetry_id_client_teleme" FOREIGN KEY("client_telemetry_id") REFERENCES "public"."client_telemetry"("id") ON DELETE CASCADE;
ALTER TABLE "public"."completed_workout" ADD CONSTRAINT "fk_completed_workout_details_id_completed_workout_activity_id" FOREIGN KEY("completed_workout_details_id") REFERENCES "public"."completed_workout_activity"("id") ON DELETE CASCADE;
ALTER TABLE "public"."completed_workout" ADD CONSTRAINT "fk_completed_workout_workout_activity_id_workout_activity_id" FOREIGN KEY("workout_activity_id") REFERENCES "public"."workout_activity"("id") ON DELETE CASCADE;
ALTER TABLE "public"."completed_workout" ADD CONSTRAINT "fk_completed_workout_workout_plan_activity_id_workout_plan_a" FOREIGN KEY("workout_plan_activity_id") REFERENCES "public"."workout_plan_activity"("id") ON DELETE CASCADE;
ALTER TABLE "public"."completed_workout" ADD CONSTRAINT "fk_completed_workout_client_telemetry_id_client_telemetry_id" FOREIGN KEY("client_telemetry_id") REFERENCES "public"."client_telemetry"("id") ON DELETE CASCADE;
